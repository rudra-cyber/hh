      ...
      <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StaggerItem>
          <motion.div 
            ...
            className="bg-[#161B22] border border-slate-800 rounded-xl p-5 transition duration-300 cursor-pointer h-full"
          >
            ...
            <div className="flex items-baseline space-x-1">
              <span className={`text-2xl font-black font-sans tracking-tight ${stats.totalProfit >= 0 ? 'text-[#00b074]' : 'text-[#f23645]'}`}>
                <AnimatedCounter value={stats.totalProfit} isCurrency={true} prefix={stats.totalProfit >= 0 ? "+$" : "$"} />
              </span>
            </div>
        ...
        <StaggerItem>
          ...
          >
            ...
            <div className="flex items-baseline space-x-1">
              <span className="text-2xl font-black font-sans tracking-tight text-yellow-400">
            ...
            <div className="flex flex-col space-y-1.5 mt-1">
              <div className="flex justify-between text-xs font-mono">
                ...
                <span className="text-[#00b074] font-black">
                  <AnimatedCounter value={stats.averageProfit} prefix="+$" />
                </span>
              </div>
              <div className="flex justify-between text-xs font-mono">
                <span className="text-[#64748b]">Avg Loss:</span>
                <span className="text-[#f23645] font-black">
                  <AnimatedCounter value={stats.averageLoss} prefix="-$" />
                </span>
              </div>
            </div>
          </motion.div>
